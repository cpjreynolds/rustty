...
mod test {
    ...
    use test::Bencher;
     ...
     #[bench]
    fn bench_cellbuffer_new_10(b: &mut Bencher) {
        b.iter(|| {
            CellBuffer::new(10, 10, Cell::default())
        });
    }

    #[bench]
    fn bench_cellbuffer_new_100(b: &mut Bencher) {
        b.iter(|| {
            CellBuffer::new(100, 100, Cell::default())
        });
    }

    #[bench]
    fn bench_cellbuffer_new_1000(b: &mut Bencher) {
        b.iter(|| {
            CellBuffer::new(1000, 1000, Cell::default())
        });
    }

    #[bench]
    fn bench_cellbuffer_clear_10(b: &mut Bencher) {
        let cell = Cell::new('x',
                             Style::new(Color::Red, Attr::Bold),
                             Style::new(Color::Blue, Attr::Reverse));
        let mut cellbuf = CellBuffer::new(10, 10, Cell::default());
    ...
    #[bench]
    fn bench_cellbuffer_clear_100(b: &mut Bencher) {
        let cell = Cell::new('x',
                             Style::new(Color::Red, Attr::Bold),
                             Style::new(Color::Blue, Attr::Reverse));
        let mut cellbuf = CellBuffer::new(100, 100, Cell::default());
    ...
    #[bench]
    fn bench_cellbuffer_clear_1000(b: &mut Bencher) {
        let cell = Cell::new('x',
                             Style::new(Color::Red, Attr::Bold),
                             Style::new(Color::Blue, Attr::Reverse));
        let mut cellbuf = CellBuffer::new(1000, 1000, Cell::default());
    ...
    #[bench]
    fn bench_cellbuffer_resize_10_20(b: &mut Bencher) {
        let cell = Cell::new('x',
                             Style::new(Color::Red, Attr::Bold),
                             Style::new(Color::Blue, Attr::Bold));
        let mut cellbuf = CellBuffer::new(0, 0, Cell::default());
        ...
        b.iter(|| {
            if n {
                n = false;
                cellbuf.resize(20, 20, cell)
            } else {
                n = true;
                cellbuf.resize(10, 10, cell)
            }
        });
    }

    #[bench]
    fn bench_cellbuffer_resize_100_200(b: &mut Bencher) {
        let cell = Cell::new('x',
                             Style::new(Color::Red, Attr::Bold),
                             Style::new(Color::Blue, Attr::Bold));
        let mut cellbuf = CellBuffer::new(0, 0, Cell::default());
        ...
        b.iter(|| {
            if n {
                n = false;
                cellbuf.resize(200, 200, cell)
            } else {
                n = true;
                cellbuf.resize(100, 100, cell)
            }
        });
    }

    #[bench]
    fn bench_cellbuffer_resize_1000_2000(b: &mut Bencher) {
        let cell = Cell::new('x',
                             Style::new(Color::Red, Attr::Bold),
                             Style::new(Color::Blue, Attr::Bold));
        let mut cellbuf = CellBuffer::new(0, 0, Cell::default());
        ...
        b.iter(|| {
            if n {
                n = false;
                cellbuf.resize(2000, 2000, cell)
            } else {
                n = true;
                cellbuf.resize(1000, 1000, cell)
            }
        });
    }
}
